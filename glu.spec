...
Source0  : https://mesa.freedesktop.org/archive/glu/glu-9.0.1.tar.gz
Source1  : https://mesa.freedesktop.org/archive/glu/glu-9.0.1.tar.gz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604441545
